...
//      timeout:     xxx milliseconds  // interrupt only
  ...
  async sendLevel() {
    ...
    this.mqttClient.publish('Regen/tele/SENSOR', JSON.stringify(result), {retain: true});
  }
...
//        return;
    ...
    logger.warn(`Regen: diff=${diffSinceLast}ms duration=${triggerDuration}ms`);
