...
//      timeout:    xxx milliseconds  // interrupt only
  ...
  async sendLevel() {
    ...
    this.mqttClient.publish('Wind/tele/SENSOR', JSON.stringify(result), {retain: true});
  }
